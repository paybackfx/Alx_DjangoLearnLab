...
This module imports and re-exports all tests from test_views.py for the API.
Tests use a separate test database (test_db.sqlite3) configured in settings.py
to avoid impacting production or development data.
...
class BookAPITestCase(APITestCase):
    ...
    Note: Tests run against a separate test database (test_db.sqlite3)
    configured in settings.py to avoid impacting production data.
    """
